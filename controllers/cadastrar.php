...
if (empty($valorEntrada)){
    ...
    $sql = "INSERT INTO receber_titulos (valor, descricao, categoria, data_lancamento) VALUES 
        (:valor, :descricao, :categoria, :data_lancamento)";
...
<html lang="pt-br" data-bs-theme="light">
    ...
    <div class="container">
        <h1 style="text-align: center;"> Lancamento Cadastrado com Sucesso </h1>
